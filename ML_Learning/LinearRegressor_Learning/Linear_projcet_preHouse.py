'''
案例：演示 正规方程法 线性回归对象 完成 波士顿房价预测案例。
...
x_train,x_test,y_trian,y_test = train_test_split(data,target,test_size=0.2,random_state=22)
...
estimator = LinearRegression(fit_intercept=True)    #fit_intercept:是否需要截距b,默认是True
#4.2 模型训练
